...
export default function ProjectManagerPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Project Manager Application:', formData)
    setSubmitted(true)
  }
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-12 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">Project Manager</h1>
          <p className="text-lg sm:text-xl text-foreground/70">
            Apply for the Project Manager position at Kiru Labs
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 pb-20">
        <div className="max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="glass-card p-8 sm:p-12 space-y-6">
            ...
            {/* Years of Experience */}
            <div>
              <label className="block text-lg font-semibold mb-2">Years of Project Management Experience *</label>
              <select
                name="experience"
            ...
            {/* Project Experience */}
            <div>
              <label className="block text-lg font-semibold mb-2">Describe Your Project Management Experience *</label>
              <textarea
                name="projects"
                ...
                placeholder="Tell us about significant projects you've managed..."
              />
            </div>

            {/* Tools & Technologies */}
            <div>
              <label className="block text-lg font-semibold mb-2">Project Management Tools & Technologies</label>
              <textarea
                name="tools"
                ...
                placeholder="e.g., Jira, Asana, Monday.com, etc."
              />
            </div>

            {/* Portfolio/LinkedIn */}
            <div>
              <label className="block text-lg font-semibold mb-2">Portfolio or LinkedIn Profile</label>
              <input
                type="url"
                name="portfolio"
