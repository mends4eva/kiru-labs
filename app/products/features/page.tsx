      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="glass-card p-8 text-center">
            <p className="text-foreground/60 mb-6">Detailed features list coming soon. Explore our solutions in the Ideas section.</p>
            <Button asChild>
              <Link href="/ideas">View Our Solutions</Link>
            </Button>
          </div>
        </div>
      </section>
