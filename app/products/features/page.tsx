    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-12 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">Features</h1>
          <p className="text-xl text-foreground/70">Discover the powerful features that make Kirulabs stand out.</p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="glass-card p-8 text-center">
            <p className="text-foreground/60 mb-6">Detailed features list coming soon. Explore our solutions in the Projects section.</p>
            <Button asChild>
              <Link href="/ideas">View Our Projects</Link>
            </Button>
          </div>
        </div>
      </section>
